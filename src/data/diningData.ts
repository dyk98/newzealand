...
export const diningStops: DiningStop[] = [
  ...
  },
  {
    ...
    plan: '目标 18:30 五人入座。Queenstown 提前至 10:00 出发，午餐后采购并在 14:00 起入住 Luxmore，再去已购 15:15 萤火虫洞；约 17:30 回镇上后衔接晚餐。晚餐后准备 Milford 并休息。',
    hours: '10.02 周五的营业、菜单和末轮入座需向店家确认，不按未核实的固定营业时间执行。',
    booking: '提前询订五人 18:30 晚餐；已购萤火虫洞约 17:30 返回。未订成时可用 The Fat Duck 或 The Ranch，不增加夜间远途活动。',
