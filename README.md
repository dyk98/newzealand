...
| 4 | 09.27 | Mt Cook 徒步，下午优先回 Twizel 休息，短线按状态择一；The Moraine 晚餐待订 |
| 5 | 09.28 | 前往 Wanaka，五人统一入住 Doug Ledgerwood Drive 房源；Racers Edge 取已订三人雪具，Kika 晚餐待订 |
| 6 | 09.29 | 3 人已购 Cardrona 单日票 NZ$552 与 Racers Edge 雪具 NZ$255；2 人 Base 闲逛；Muttonbird 晚餐待订 |
| 7 | 09.30 | Real Guns（10:00 优先询订）-> 箭镇可选 -> Queenstown；Botswana 晚餐待订 |
| 8 | 10.01 | Hydro Attack 五人待订；Skyline 缆车 + 每人 3 次 Luge 已购 ¥1,777.90；True South 晚餐待订 |
| 9 | 10.02 | 10:00 提前出发去 Te Anau，入住后参加已购 15:15 萤火虫洞 ¥2,979.37；18:30 The Redcliff 待订 |
| 10 | 10.03 | SH94 自驾往返，主付费停车场；RealNZ 避风港号五人票已购 ¥3,323.55、12:45 报到，返抵后 The Fat Duck 19:30 待订 |
| 11 | 10.04 | 回 Queenstown 后休整；Amisfield 晚间品鉴及五人往返接送待订 |
| 12 | 10.05 | Stoaker 午餐 -> Omarama 短休 -> Tekapo 入住；Kohan 晚餐后住宿附近免费自由观星，不订付费团 |
...
- 当前按 5 人出行维护；实际入住方案合计 ¥43,033.03 人民币。10.05–10.06 已改为 17 Coulson Lane, Lake Tekapo 的 1 间房，一晚 ¥4,976.71；10.04–10.05 Pinewood 当前仅保留原 1 间四人房 ¥1,018.38，第 5 人该晚床位仍需落实。
- 仅原 09.28–09.30 汉普郡假日公园 ¥1,177.62 尚未退订，暂保留在费用中；其他已退旧单不计入。全程住宿当前暂计 ¥44,210.65 人民币；剩余退款到账后按实际退回金额扣减，不恢复旧入住或分住安排。
- 餐饮按五人、无忌口、预算不限规划；12 顿主线餐厅及五人订位、接送检查已加入，各餐仍为待订，不加入已付住宿合计。
- 原机票、签证记录不变；Skyline 五人缆车 + 每人 3 次 Luge 已购 ¥1,777.90，Te Anau 萤火虫洞 15:15 班次已购 ¥2,979.37，RealNZ 避风港号五人船票已购 ¥3,323.55，09.29 Cardrona 三人单日票已购 NZ$552（订单 CT291054），Racers Edge 三人雪具已购 NZ$255（订单 251514190424594）。其余活动仍未预订，不能沿用旧滑雪自动完成标记。
...
- 10.02 Te Anau Glowworm Caves 五人 15:15 班次已购，实付 ¥2,979.37；14:45 报到，约 17:30 返回。资料仍集中在 `src/data/activityData.ts`。10.05 Summit 付费观星团已经取消并从待订与预算移除。
- 待订活动资料集中维护在 `src/data/activityData.ts`。正式下单前一起确认五人名额、价格、退改与餐厅衔接。
- 09.27 以徒步和下午休息为主，有余量才补一条短线；10.02 提前至 10:00 出发给已购洞穴团留时间；10.05 Kohan 晚餐后只在住宿附近免费自由观星，不为观星开夜路，次日驾驶睡眠优先。
- 09.29 Cardrona 三人单日票已购 NZ$552（订单 CT291054）；另外 2 人不上雪，随接驳到 Base 闲逛。3 人雪具已订 Racers Edge（22 Ardmore Street），订单 251514190424594，Performance Snowboard Set + Helmet × 3，实付 NZ$255；09.28 入住后取具，09.29 归还。
- 待订活动与餐厅使用新的 `-five-review` 待办 ID，不继承旧完成状态。Skyline、萤火虫洞、Milford、Cardrona 三人雪票与 Racers Edge 雪具使用独立已购 ID，自动进入已完成清单；已订住宿、租车及其勾选记录不变。
- 主线为 6 项活动 + 1 项雪具租赁 + 12 顿餐厅，共 19 项；Skyline 五人订单实付 ¥1,777.90，萤火虫洞五人实付 ¥2,979.37、15:15 开船，RealNZ 避风港号五人船票实付 ¥3,323.55、12:45 报到，Cardrona 三人雪票实付 NZ$552，Racers Edge 三人雪具实付 NZ$255。剩余 2 项活动和 12 顿餐厅，共 14 项待订；付费观星已取消，澳洲两家餐厅仍是条件性候选。
- Milford 不再报大巴团：10.03 从 Te Anau 沿 SH94 自驾往返约 240 km，选择游客中心附近的主付费停车场，按当前 NZ$10 / 小时准备至少 4 小时。发船时间以订单为准，不由 12:45 报到时间自行推算；正式执行前复核道路、Homer Tunnel、雪链、船班和司机状态。
- 验证：`npm run verify:activities` 检查日期、待订状态、引用、旧状态隔离与关键行程边界，并渲染准备页和新增活动日。
